...
MAP_NOME_SCUOLA_FILE_CIRCOLO = {
    ...
    'CIMONE': 4,
    'CIVEZZANO': 1,
    'CLARINA_PICCOLO_MONDO': 3,
    'CLES': 7,
    'COGOLO': 11,
    'CRISTO_RE_PICCOLO_PRINCIPE': 3,
    'CROSINA_SARTORI': 3,
    'CUNEVO': 7,
    'DAIANO-VARENA': 1,
    'DARZO': 8,
    'DRO': 8,
    'FAI_DELLA_PAGANELLA': 7,
    'FIEROZZO': 1,
    'FOLGARIA': 12,
    'FUCINE': 9,
    'GARDOLO_PALUDI': 5,
    ...
    'PELLIZZANO': 11,
    'PERA': 13,
    'PIAZZA_DI_TERRAGNOLO': 9,
    'PIAZZE': 1,
    'PIEDICASTELLO': 5,
    'POMAROLO': 10,
    'POVO_MARIACHIARA_CONOTTER': 3,
    'PREORE': 8,
    'RABBI': 11,
    'RALLO': 7,
    'RAVINA': 4,
    ...
    'SANT_ILARIO': 10,
    'SAN_GIORGIO': 9,
    'SAN_GIUSEPPE_MASO_GINOCCHIO': 4,
    'SAN_MARTINO': 3,
    'SAN_MICHELE_ALL_ADIGE': 7,
    'SARDAGNA': 5,
    'SARNONICO': 11,
    'SEREGNANO': 1,
    'SOLTERI': 6,
...
class ScuolaInfanziaXLSX:
    ...
    def __init__(self, name_abspath_xlsx_file, dict_studiodt_experiment_design, toggle_check_read=False):
        ...
        self.club_code = MAP_NOME_SCUOLA_FILE_CIRCOLO[self.school_name]
    ...
    def read_xlsx_file(self):
        ...
        series_nome_scuola_file = pd.Series(
            ...
            name='nome_scuola_file')
        series_numero_circolo = pd.Series(
            [self.club_code for row in range(len(self.dataframe_scuola_infanzia_misura))],
            name='numero_circolo')
        self.dataframe_scuola_infanzia_misura = pd.concat(
            [series_nome_scuola_file,
             series_numero_circolo,
             self.dataframe_scuola_infanzia_misura],
            axis=1)
        return True
